######################################################
# 第9分支、近端、不同频率刺激下，采用Chen可塑性模型，从近端到远端的势能和权值分布的图形显示
######################################################
...
plt.savefig('IMG/'+'fig4ba.eps', format='eps', dpi=1000)
plt.show()
...
#plt.xlabel('Distance from stimulation site',fontdict={'family': 'Times New Roman','size':8})
plt.ylabel('Potential energy\n(fJ/$\mu m^2$)',fontdict={'family': 'Times New Roman','size':8})
plt.savefig('IMG/'+'fig4bb.eps', format='eps', dpi=1000)
plt.show()
...
plt.savefig('IMG/'+'fig4bc.eps', format='eps', dpi=1000)
plt.show()
