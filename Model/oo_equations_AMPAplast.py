...
chen_1_plastAMPA =   '''
            ...
            wgaba :1
            dMEdamp/dt = -ME_Ascale*MEdamp/MEtau   : 1 (clock-driven) 
            dMEmax/dt = ME_Ascale*MEmaxRatio/second   : 1 (clock-driven)
            dPE/dt = (sign(MEdamp*MEmax+MESmax0-abs(PE)))*ME_Ascale*v_post/mV*Im1_post /second   : 1 (clock-driven) 
            dwampa/dt = (sign(MEdamp*MEmax+MESmax0-abs(PE)))*ME_Ascale*ME_A*(ME_Ar*(v_post/mV < ME_Vrhigh/mV)*v_post/mV*Im1_post - (v_post/mV >= ME_Vrhigh/mV)*v_post/mV*Im1_post) /second   : 1 (clock-driven)
            dErest/dt = (sign(MEdamp*MEmax+MESmax0-abs(PE)))*ME_Ascale*ME_Ar*(v_post/mV < ME_Vrhigh/mV)*v_post/mV*Im1_post /second   : 1 (clock-driven)
			dEfire/dt = (sign(MEdamp*MEmax+MESmax0-abs(PE)))*ME_Ascale*(v_post/mV >= ME_Vrhigh/mV)*v_post/mV*Im1_post /second   : 1 (clock-driven) 
            '''	
...
eq_1_plastAMPA =   ('''
            ...
            *(v_post/mV - Theta_high/mV)*(v_post/mV - Theta_high/mV > 0))/second : 1 (clock-driven)
            dg_nmda/dt = -g_nmda/tau_NMDA : siemens (clock-driven)
            gNMDA_post = g_nmda : siemens (summed) 
            wnmda :1 
            dg_gaba/dt = -g_gaba/tau_gaba : siemens (clock-driven)
